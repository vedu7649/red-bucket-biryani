  ...
  return (
    <section className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
      <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-center">
        <div className="space-y-10 md:space-y-12 flex-1 w-full">
          <div className="flex flex-col space-y-4 md:space-y-6">
            <h2 className="text-4xl md:text-6xl lg:text-8xl font-black text-white uppercase tracking-tighter leading-tight">
              A Legacy of <span className="text-red-700">Hub Excellence</span>
            </h2>
            <p className="text-white/40 text-base md:text-xl lg:text-2xl font-light leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-6 md:gap-8 w-full">
            <div className="flex-1 flex items-start space-x-4 md:space-x-6 p-5 md:p-6 rounded-3xl bg-white/5 border border-white/10 min-w-0">
              <div className="bg-red-600/10 p-3 rounded-xl border border-red-600/20 shrink-0">
                <History className="text-red-600" size={24} />
              </div>
              <div className="space-y-2 min-w-0">
                <h4 className="text-white font-bold uppercase tracking-widest text-[10px] md:text-xs truncate">30+ Years</h4>
            ...
            <div className="flex-1 flex items-start space-x-4 md:space-x-6 p-5 md:p-6 rounded-3xl bg-white/5 border border-white/10 min-w-0">
              ...
              <div className="space-y-2 min-w-0">
                <h4 className="text-white font-bold uppercase tracking-widest text-[10px] md:text-xs truncate">Expertise</h4>
        ...
        <div className="relative group w-full flex-1 mt-6 lg:mt-0">
          <div className="absolute -inset-10 blur-3xl bg-red-600/5 transition group-hover:bg-red-600/10 pointer-events-none" />
          <div className="relative bg-white/5 border border-white/10 p-8 sm:p-10 md:p-16 rounded-[32px] md:rounded-[48px] backdrop-blur-3xl space-y-8 md:space-y-10 w-full">
            <div className="flex items-center space-x-4">
              <div className="w-8 md:w-12 h-[2px] md:h-1 bg-red-600 shrink-0" />
